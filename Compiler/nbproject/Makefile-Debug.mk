...
${OBJECTDIR}/src/Assembler.o: src/Assembler.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Assembler.o src/Assembler.cpp
...
${OBJECTDIR}/src/BreakBranch.o: src/BreakBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BreakBranch.o src/BreakBranch.cpp
...
${OBJECTDIR}/src/ContinueBranch.o: src/ContinueBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ContinueBranch.o src/ContinueBranch.cpp
...
${OBJECTDIR}/src/MacroIfDefBranch.o: src/MacroIfDefBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MacroIfDefBranch.o src/MacroIfDefBranch.cpp
...
${OBJECTDIR}/src/Preprocessor.o: src/Preprocessor.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Preprocessor.o src/Preprocessor.cpp
...
${OBJECTDIR}/src/TreeImprover.o: src/TreeImprover.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TreeImprover.o src/TreeImprover.cpp
...
${OBJECTDIR}/src/VirtualObjectFormat.o: src/VirtualObjectFormat.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VirtualObjectFormat.o src/VirtualObjectFormat.cpp

${OBJECTDIR}/src/VirtualSegment.o: src/VirtualSegment.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VirtualSegment.o src/VirtualSegment.cpp

${OBJECTDIR}/src/WhileBranch.o: src/WhileBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WhileBranch.o src/WhileBranch.cpp
