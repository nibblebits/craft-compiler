...
${OBJECTDIR}/src/Hook.o: src/Hook.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG_MODE -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Hook.o src/Hook.cpp
...
${OBJECTDIR}/src/InvokeableHook.o: src/InvokeableHook.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG_MODE -Iinclude -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/InvokeableHook.o src/InvokeableHook.cpp
