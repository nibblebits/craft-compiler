...
${OBJECTDIR}/src/ASMArgsBranch.o: src/ASMArgsBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ASMArgsBranch.o src/ASMArgsBranch.cpp
...
${OBJECTDIR}/src/FuncArgumentsBranch.o: src/FuncArgumentsBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FuncArgumentsBranch.o src/FuncArgumentsBranch.cpp
...
${OBJECTDIR}/src/MacroFuncCallBranch.o: src/MacroFuncCallBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MacroFuncCallBranch.o src/MacroFuncCallBranch.cpp
...
${OBJECTDIR}/src/ReturnBranch.o: src/ReturnBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ReturnBranch.o src/ReturnBranch.cpp
...
${OBJECTDIR}/src/STRUCTDescriptorBranch.o: src/STRUCTDescriptorBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/STRUCTDescriptorBranch.o src/STRUCTDescriptorBranch.cpp
...
${OBJECTDIR}/src/StandardScopeBranch.o: src/StandardScopeBranch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StandardScopeBranch.o src/StandardScopeBranch.cpp
