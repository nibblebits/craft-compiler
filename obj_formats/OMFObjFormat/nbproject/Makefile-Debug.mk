...
${OBJECTDIR}/src/OMFObjectFormat.o: src/OMFObjectFormat.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG_MODE -Iinclude -I../../libs/MagicOMF/include -I../../Compiler/include -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/OMFObjectFormat.o src/OMFObjectFormat.cpp

${OBJECTDIR}/src/main.o: src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG_MODE -Iinclude -I../../libs/MagicOMF/include -I../../Compiler/include -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
