...
enum
{
    ...
    TEST_MEM_WITH_REG_W0,
    TEST_MEM_WITH_REG_W1,
    TEST_REG_WITH_MEM_W0,
    TEST_REG_WITH_MEM_W1,
    TEST_ACC_WITH_IMM_W0,
    TEST_ACC_WITH_IMM_W1,
    TEST_REG_WITH_IMM_W0,
    TEST_REG_WITH_IMM_W1,
    
    XCHG_REG_WITH_REG_W0,
    XCHG_REG_WITH_REG_W1
...
private:
    ...
    bool has_global(std::string global_name);
